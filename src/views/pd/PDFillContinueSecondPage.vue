  ...
  export default {
    ...
    data () {
      return {
        ...
        firstQos: {userInfoId: this.$str.female_Known_Pendi_Kangfu_Id, userInfoValue: ''},
        secondQos: {userInfoId: this.$str.female_Louniao_Tuochui_Id, userInfoValue: ''},
        thirdQos: {userInfoId: this.$str.female_Yindao_SongChi_Id, userInfoValue: ''},
        forthQos: {userInfoId: this.$str.female_Yindao_Shousuo_Xiajiang_Id, userInfoValue: ''},
        fifthQos: {userInfoId: this.$str.female_Xinggongneng_Xiajiang_Id, userInfoValue: ''},
        sixthQos: {userInfoId: this.$str.female_Medical_History_Id, userInfoValue: ''},
