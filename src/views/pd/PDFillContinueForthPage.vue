  ...
  export default {
    ...
    data () {
      return {
        ...
        firstQos: {userInfoId: this.$str.female_Fuzhiji_Fenli_Id, userInfoValue: ''},
        secondQos: {userInfoId: this.$str.female_Fubi_Songchi_Id, userInfoValue: ''},
        thirdQos: {userInfoId: this.$str.female_Tunbu_songchi_Id, userInfoValue: ''},
        forthQos: {userInfoId: this.$str.female_Ruxian_Zengsheng_Id, userInfoValue: ''},
        fifthQos: {userInfoId: this.$str.female_Jianjin_suantong_Id, userInfoValue: ''},
        sixthQos: {userInfoId: this.$str.female_Yaobei_suantong_Id, userInfoValue: ''},
        seventhQos: {userInfoId: this.$str.female_Jirou_Suantong_Id, userInfoValue: ''},
