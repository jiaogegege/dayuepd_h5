  ...
  export default {
    ...
    data () {
      return {
        ...
        firstQos: {userInfoId: this.$str.female_Buruqi_Id_NoMore, userInfoValue: ''},
        secondQos: {userInfoId: this.$str.female_Tianjia_naifen_Id_NoMore, userInfoValue: ''},
        thirdQos: {userInfoId: this.$str.female_Xiruqi_Id_NoMore, userInfoValue: ''},
        forthQos: {userInfoId: this.$str.female_Ruzhangtong_Id_NoMore, userInfoValue: ''},
        fifthQos: {userInfoId: this.$str.female_Rutou_Neixian_Id_NoMore, userInfoValue: ''},
        sixthQos: {userInfoId: this.$str.female_Zigongfujiu_Id_NoMore, userInfoValue: ''},
        seventhQos: {userInfoId: this.$str.female_Tianjia_Naifen_Cishu_Id_NoMore, userInfoValue: ''},
        eighthQos: {userInfoId: this.$str.female_Xiruqi_Zhonglei_Id_NoMore, userInfoValue: ''},
