      ...
      <mu-flex class="wrapper" direction="column" align-items="center">
        ...
        <mu-flex class="content" direction="column" align-items="center">
          <div class="first item">
            <p>您是否有腹直肌分离的症状？</p>
            <selection-view class="first-qos selection-view"
  ...
  export default {
    ...
    data () {
      return {
        ...
        firstQos: {userInfoId: this.$str.female_Un_Fuzhiji_Fenli_Id, userInfoValue: ''},
        secondQos: {userInfoId: this.$str.female_Un_Fubi_Songchi_Id, userInfoValue: ''},
        thirdQos: {userInfoId: this.$str.female_Un_Tunbu_songchi_Id, userInfoValue: ''},
        forthQos: {userInfoId: this.$str.female_Un_Ruxian_Zengsheng_Id, userInfoValue: ''},
        fifthQos: {userInfoId: this.$str.female_Un_Jianjin_suantong_Id, userInfoValue: ''},
        sixthQos: {userInfoId: this.$str.female_Un_Yaobei_suantong_Id, userInfoValue: ''},
        seventhQos: {userInfoId: this.$str.female_Un_Jirou_Suantong_Id, userInfoValue: ''},
